...
;$.fn.zSign = function (options) {
    ...
    var _btnPanel = $("<div class='panel' style='display: none'><button class='btn add' id='z-sign-ok'>盖 章</button><button class='btn cancel'>关 闭</button></div>").appendTo(_parent);
    ...
    var _html = "<div class='sign' style='height:" + _s.height + "px;width:" + _s.width + "px;top:" + _s.offset + "px;left:660px;z-index:999'><img src='" + _s.img + "' draggable='false' style='z-index:999'/><button class='btn ok' style='display: none'>确定</button><button class='btn del' style='display: none'>删除</button></div>";
