 ...
 * Date： 2016/10/20.
 */
public interface NurseRecordWriteMapper extends NurseRecordInterface{
...
/* =============================================================== end */
    ...
    String getMergeRule(@Param(value = "JGBH") String jgbh,@Param(value = "ZYH") String zyh,@Param(value = "YHID") String yhid,@Param(value = "JLSJ") String jlsj,@Param(value = "dbtype") String dbtype);

	List<NRItem> getNRItemsForSync(@Param(value = "JLBH") String jlbh);

	Integer updateNRItemsForSyncDel(@Param(value = "MXBHLIST") List<Long> mxbhList);

	Integer updateNRDataForSyncDel(@Param(value = "JLBH") String jlbh);

    Integer updatePrimaryRecordLines(@Param(value = "JLBH") String jlbh);

    List<NRData> getNRDatas(@Param(value = "ZYH") String zyh, @Param(value = "JGBH") String jgbh, @Param(value = "JLSJ") String nowStr,@Param(value = "dbtype") String dbtype);

    List<Map> getExsitProjectsInRecord(Map map);
}
